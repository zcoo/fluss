...
public class ConfigOptions {
    ...
    public static final ConfigOption<ArrowCompressionType> CLIENT_WRITER_ARROW_COMPRESSION_TYPE =
            key("client.writer.arrow-compression-type")
                    .enumType(ArrowCompressionType.class)
                    .defaultValue(ArrowCompressionType.NO)
                    .withDescription(
                            "The compression type for the input log batch when the log format set as ARROW. "
    ...
    public static final ConfigOption<ArrowCompressionType> KV_CDC_ARROW_COMPRESSION_TYPE =
            key("kv.cdc.arrow-compression-type")
                    .enumType(ArrowCompressionType.class)
                    .defaultValue(ArrowCompressionType.NO)
                    .withDescription(
                            "The compression type for the cdc log generated by kv table when the log format set as ARROW. "
                                    + "The candidate compression type is "
                                    + Arrays.toString(ArrowCompressionType.values()));
