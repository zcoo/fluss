...
public final class GenericArray implements InternalArray, Serializable {
    ...
    public BinaryString getChar(int pos, int length) {
        return isPrimitiveArray ? ((BinaryString[]) array)[pos] : (BinaryString) getObject(pos);
    }

    @Override
    public TimestampNtz getTimestampNtz(int pos, int precision) {
        return (TimestampNtz) getObject(pos);
    }

    @Override
    public TimestampLtz getTimestampLtz(int pos, int precision) {
        return (TimestampLtz) getObject(pos);
    }
    ...
    public static GenericArray of(Object... values) {
