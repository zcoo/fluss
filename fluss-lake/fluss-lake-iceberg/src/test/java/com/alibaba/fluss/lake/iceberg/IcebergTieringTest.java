...
class IcebergTieringTest {
    ...
    @Test
    void testTieringWriteTableExtra1() throws Exception {
        testTieringWriteTable(true, true);
    }

    @Test
    void testTieringWriteTableExtra2() throws Exception {
        testTieringWriteTable(true, false);
    }

    @Test
    void testTieringWriteTableExtra3() throws Exception {
        testTieringWriteTable(false, true);
    }

    @Test
    void testTieringWriteTableExtra4() throws Exception {
        testTieringWriteTable(false, false);
    }
